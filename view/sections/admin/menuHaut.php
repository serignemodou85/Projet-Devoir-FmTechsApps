    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu media-list dropdown-menu-right">
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="public/templates/templateAdmin/assets/img/user/user-1.jpg" class="media-object"
                            alt="" />
                        <i class="fab fa-facebook-messenger text-blue media-object-icon"></i>
                    </div>
                    <div class="media-body">
                        <h6 class="media-heading">Modou Fall</h6>
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="public/templates/templateAdmin/assets/img/user/user-2.jpg" class="media-object"
                            alt="" />
                        <i class="fab fa-facebook-messenger text-blue media-object-icon"></i>
                    </div>
                    <div class="media-body">
        ...
        <li class="dropdown navbar-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="d-none d-md-inline">Modou Fall</span> <b class="caret"></b>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:;" class="dropdown-item">Deconnexion</a>
            </div>
        </li>
    </ul>
    <!-- end header-nav -->
